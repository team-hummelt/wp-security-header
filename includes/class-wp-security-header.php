...
class Wp_Security_Header {
	...
	public function __construct() {
		if ( defined( 'WP_SECURITY_HEADER_VERSION' ) ) {
			$this->version = WP_SECURITY_HEADER_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'wp-security-header';
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Wp_Security_Header_Admin( $this->get_plugin_name(), $this->get_version() );
