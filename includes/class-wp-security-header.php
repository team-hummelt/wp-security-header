...
use Twig\TwigFilter;
use WPSecurity\Header\Endpoint\Srv_Api_Endpoint;
...
class Wp_Security_Header
{
    ...
    public function __construct()
    {
        ...
        $this->register_wp_security_header_rest_endpoint();
     ...
     * @access   private
     */
    private function register_wp_security_header_rest_endpoint()
    {
        global $security_header_public_endpoint;
        $security_header_public_endpoint = new Srv_Api_Endpoint($this->plugin_name, $this->version, $this->main);
        $this->loader->add_action('rest_api_init', $security_header_public_endpoint, 'register_routes');
